    ...
    >
      ...
      <div className="container mx-auto max-w-7xl">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            >
              <Button 
                ...
                asChild
              >
                <Link href="/estrategias" className="inline-flex items-center relative z-10">
          ...
          <motion.div 
            className="lg:col-span-5 xl:col-span-6 relative h-[400px] md:h-[500px] lg:h-[600px] rounded-2xl overflow-hidden border border-border/20 shadow-2xl bg-background/50 backdrop-blur-md"
